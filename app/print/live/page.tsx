...
import { OptimizationResult, BarResult } from '@/lib/types';
...
export default function PrintLivePage() {
    ...
    if (!data || !data.result) return <div className="p-10 text-center font-mono text-red-600">Nenhum dado de impressão encontrado. Volte para a tela de resultados e clique novamente em &quot;Ficha de Corte&quot;.</div>;
                ...
                <div className="border-2 border-gray-900 p-4 mb-6">
                    <div className="flex justify-between items-start">
                        ...
                        <div className="text-right text-sm">
                            <p><strong>Data:</strong> {new Date(data.createdAt).toLocaleDateString('pt-BR')}</p>
