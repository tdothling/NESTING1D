...
export function optimizeCuts(
  requests: CutRequest[],
  stock: StockItem[],
  options: OptimizerOptions = { standardBarLengths: {}, defaultStandardLength: 6000, kerf: 3 }
): { results: BarResult[]; remainingStock: StockItem[]; itemsNotFit: CutRequest[]; purchaseList: PurchaseItem[] } {
  ...
  return { results: allResults, remainingStock: currentStock, itemsNotFit: allItemsNotFit, purchaseList };
}
